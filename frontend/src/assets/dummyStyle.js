...
export const getBadgeClasses = (percent) => {
  if (percent >= 85)
    return "inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-gradient-to-r from-emerald-100 to-emerald-50 text-emerald-800 border border-emerald-200";
  if (percent >= 65)
    return "inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-gradient-to-r from-indigo-100 to-indigo-50 text-indigo-800 border border-indigo-200";
  if (percent >= 45)
    return "inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-gradient-to-r from-yellow-100 to-yellow-50 text-yellow-800 border border-yellow-200";
...
export const resultPageStyles = {
  // Main container styles
  container:
    "min-h-screen font-[pacifico] bg-gradient-to-br from-gray-50 to-gray-100 p-4 md:p-6",
  innerContainer: "max-w-6xl mx-auto",

  // Header styles
  header: "mb-8 md:mb-10 flex justify-center",
  headerBox:
    "bg-white rounded-full p-6 md:p-8 shadow-sm border border-gray-100 text-center min-w-[260px]",
  headerTitle:
    "text-2xl md:text-3xl font-extrabold tracking-tight leading-tight bg-gradient-to-r from-indigo-600 via-pink-500 to-yellow-500 bg-clip-text text-transparent animate-fade-in-up",

  // Track section styles
  trackSection: "mb-8 md:mb-10",
  trackHeader: "flex items-center justify-between mb-4",
  trackTitle:
    "text-xl md:text-2xl font-bold shadow-md bg-gradient-to-r from-indigo-600 via-pink-500 to-yellow-500 bg-clip-text text-transparent bg-white px-4 py-2 rounded-full border border-gray-100",
  ...
  stripCardIconContainer: (colors) =>
    `flex items-center justify-center w-12 h-12 rounded-xl ${colors.iconBg} border`,
  ...
  stripCardStartedAtBox:
    "mt-3 bg-gray-50 p-3 rounded-lg border border-gray-100",
...
export const sidebarStyles = {
  ...
  flexContainer:
    "flex xl:h-screen xl:overflow-y-hidden lg:h-screen lg:overflow-y-hidden",
  ...
  // Sidebar styles
  sidebar:
    "fixed h-screen font-mono z-40 top-0 left-0 w-80 transform transition-transform duration-300 ease-in-out bg-white/90 backdrop-blur-sm shadow-2xl rounded-r-3xl overflow-y-auto border-r border-white/30 lg:relative lg:translate-x-0 lg:flex lg:flex-col",
  sidebarOpen: "translate-x-0",
  sidebarClosed: "-translate-x-full",

  // Sidebar header
  sidebarHeader:
    "sticky top-0 z-20 p-6 bg-gradient-to-br from-rose-50/95 to-amber-50/95 border-b border-blue-100/50 backdrop-blur-sm",
  headerContent: "flex items-center justify-between relative z-10",
  logoContainer: "flex items-center space-x-3",
  logoIcon:
    "p-2 bg-gradient-to-br from-blue-100 to-indigo-100 rounded-xl shadow-lg",
  ...
  closeButton:
    "p-2 rounded-lg bg-white/60 hover:bg-white/80 transition lg:hidden",
  ...
  techTitleAccent:
    "w-1 h-4 bg-gradient-to-b from-blue-400 to-purple-400 rounded-full",
  techCountBadge:
    "text-xs bg-gradient-to-r from-blue-100 to-purple-100 text-blue-800 px-3 py-1 rounded-full",

  // Technology buttons
  techButton:
    "w-full flex items-center justify-between p-4 rounded-2xl transition-all duration-300 border backdrop-blur-sm",
  techButtonSelected:
    "border-blue-400 cursor-pointer  shadow-lg transform scale-[1.02]",
  techButtonUnselected:
    "border-white/50  hover:border-blue-300 cursor-pointer hover:shadow-md hover:bg-white/50",
  ...
  levelContainer:
    "mt-3 ml-2 p-3 bg-white/60 backdrop-blur-sm rounded-2xl border border-white/50 shadow-sm",
  levelButton:
    "w-full p-3 my-2 rounded-xl border transition-all backdrop-blur-sm",
  ...
  questionCountBadge:
    "text-xs bg-gradient-to-r from-gray-100 to-gray-200 text-slate-700 px-2 py-1 rounded-full mb-1",
  timeBadge:
    "text-xs bg-gradient-to-r from-blue-100 to-indigo-100 text-blue-700 px-2 py-0.5 rounded-full",
  progressContainer: "flex items-center justify-between w-full mt-1",
  answeredBadge:
    "text-xs bg-gradient-to-r from-emerald-100 to-teal-100 text-emerald-700 px-2 py-0.5 rounded-full",
  completedBadge:
    "text-xs bg-gradient-to-r from-purple-100 to-violet-100 text-purple-700 px-2 py-0.5 rounded-full",

  // Sidebar footer
  sidebarFooter:
    "sticky bottom-0 z-20 p-4 border-t border-white/30 bg-white/80 backdrop-blur-sm",
  ...
  // Main content header
  mainContent:
    "flex-1 font-mono min-h-screen p-4 md:p-8 ml-0 md:ml-0 overflow-y-auto",
  mobileHeader: "flex items-center justify-between mb-4",
  hamburgerButton:
    "p-2 rounded-xl lg:hidden bg-white/80 backdrop-blur-sm shadow-lg",

  // Mobile level selection
  mobileLevelContainer: "lg:hidden mb-4",
  mobileLevelScroll: "flex gap-2 overflow-x-auto pb-2",
  mobileLevelButton:
    "flex-none px-4 py-3 rounded-2xl border border-white/50 bg-white/80 backdrop-blur-sm shadow-lg min-w-[140px]",
  ...
  emptyState:
    "h-full overflow-y-hidden pb-40 font-serif flex items-center justify-center py-16 px-4",
  emptyStateCard:
    "text-center w-full max-w-3xl mx-auto bg-gradient-to-br from-rose-50/95 to-amber-50/95 backdrop-blur-xl p-6 md:p-8 rounded-3xl shadow-xl shadow-rose-200/40 border border-rose-100/50",
  emptyStateHeader: "mb-8",
  emptyStateIconContainer:
    "inline-flex items-center justify-center p-3 bg-gradient-to-br from-rose-100 to-orange-100 rounded-2xl mb-4",
  emptyStateTitle:
    "text-2xl md:text-3xl font-bold bg-gradient-to-r from-rose-600 via-orange-500 to-amber-500 bg-clip-text text-transparent mb-3",
  emptyStateSubtitle:
    "text-sm md:text-base text-slate-800 mb-6 max-w-md mx-auto leading-relaxed",
  featureCardsGrid:
    "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-4 mb-8",

  // Feature card
  featureCard: "group relative h-full",
  featureCardGlow:
    "absolute -inset-0.5 rounded-xl blur-sm opacity-20 group-hover:opacity-30 transition duration-300",
  featureCardBody:
    "relative bg-white/95 p-5 rounded-xl border backdrop-blur-sm text-center h-full flex  flex-col",
  featureCardIconContainer:
    "inline-flex items-center justify-center p-2 rounded-lg mb-3 ring-1",
  ...
  // Call to action
  ctaContainer:
    "relative overflow-hidden rounded-xl bg-gradient-to-r from-white to-rose-50/80 p-4 border border-rose-200/50",
  ctaAccent:
    "absolute top-0 left-0 w-full h-0.5 bg-gradient-to-r from-rose-500 via-orange-500 to-amber-500",
  ...
  techSelectedCard:
    "text-center bg-white/90 backdrop-blur-xl p-8 md:p-12 rounded-3xl shadow-2xl border border-white/30 max-w-md",
  techSelectedIcon: "p-5 rounded-2xl shadow-xl inline-flex mb-6",
  techSelectedTitle:
    "text-2xl md:text-3xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent mb-2",
  techSelectedSubtitle: "text-slate-600 mb-6",
  progressList: "mb-6 space-y-2",
  progressItem:
    "bg-gradient-to-r from-emerald-50/80 to-teal-50/80 p-3 rounded-xl border border-emerald-200/50 backdrop-blur-sm",
  progressText: "text-emerald-700 font-medium",
  readyMessage:
    "bg-gradient-to-r from-blue-50/80 to-purple-50/80 p-4 rounded-2xl border border-blue-200/50 backdrop-blur-sm",
  readyText: "text-blue-700 font-medium",

  // Results screen
  resultsScreen:
    "h-full mt-20 md:pb-20 lg:mt-40 mb-30 font-serif flex items-center justify-center py-10",
  resultsCard:
    "bg-white/90 backdrop-blur-xl p-8 md:p-12 rounded-3xl shadow-2xl border border-white/30 max-w-2xl w-full",
  resultsHeader: "text-center",
  resultsIconContainer: "p-5 rounded-2xl shadow-lg inline-flex mb-6",
  resultsTitle:
    "text-3xl md:text-4xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent mb-2",
  ...
  // Time taken display
  timeTakenContainer:
    "mb-6 bg-gradient-to-r from-blue-50/80 to-indigo-50/80 p-5 rounded-2xl border border-blue-200/50 backdrop-blur-sm",
  timeTakenHeader: "flex items-center justify-center mb-3",
  timeTakenIcon:
    "text-blue-600 mb-7 md:mb-0 lg:mb-0 xl:mb-0 xl:ml-0 md:ml-0 xl:ml-0 ml-4 md:mr-2",
  ...
  overallScoreContainer:
    "bg-gradient-to-r from-indigo-50/80 to-blue-50/80 p-5 rounded-2xl border border-indigo-200/50 backdrop-blur-sm mb-6",
  ...
  progressBarContainer:
    "w-full bg-gradient-to-r from-gray-200 to-gray-300 rounded-full h-3",
  progressBar: "h-3 rounded-full",
  scoreDescription: "mt-2 text-sm text-slate-600",

  // Results buttons
  resultsButtonsContainer:
    "flex flex-col md:flex-col lg:flex-row sm:flex-row gap-3 justify-center",
  reviewButton:
    "px-6 py-3 cursor-pointer bg-gradient-to-r from-purple-500 to-indigo-500 text-white font-medium rounded-xl hover:from-purple-600 hover:to-indigo-600 transition-all shadow-lg hover:shadow-xl flex items-center justify-center space-x-2",
  restartButton:
    "px-6 py-3 cursor-pointer bg-gradient-to-r from-gray-100 to-gray-200 text-gray-700 font-medium rounded-xl hover:from-gray-200 hover:to-gray-300 transition-all border border-gray-300/50 shadow-lg hover:shadow-xl flex items-center justify-center space-x-2",

  // Start quiz screen
  startQuizScreen:
    "h-full font-serif flex items-center overflow-y-hidden justify-center py-10",
  startQuizCard:
    "bg-white/90 backdrop-blur-xl p-8 md:p-12 rounded-3xl border border-white/30 max-w-2xl w-full",
  startQuizHeader: "text-center",
  startQuizIconContainer:
    "p-5 rounded-2xl bg-gradient-to-br from-blue-100 to-indigo-100 shadow-xl inline-flex mb-6",
  startQuizTitle:
    "text-3xl md:text-4xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent mb-2",
  ...
  // Quiz info card
  quizInfoCard:
    "bg-gradient-to-r from-blue-50/80 to-indigo-50/80 p-5 rounded-2xl border border-blue-200/50 backdrop-blur-sm mb-6",
  quizInfoHeader:
    "flex flex-col md:flex-row lg:flex-row items-center justify-between mb-4",
  ...
  // Progress warning
  progressWarning:
    "mb-6 p-4 bg-gradient-to-r from-amber-50/80 to-orange-50/80 rounded-2xl border border-amber-200/50 backdrop-blur-sm",
  warningText: "text-amber-700 font-medium",

  // Start quiz buttons
  startButtonsContainer: "flex flex-col sm:flex-row gap-4 justify-center",
  startButton:
    "px-8 py-3 cursor-pointer bg-gradient-to-r from-emerald-500 to-teal-500 text-white font-medium rounded-xl hover:from-emerald-600 hover:to-teal-600 transition-all shadow-lg hover:shadow-xl flex items-center justify-center space-x-2",
  changeLevelButton:
    "px-8 py-3 cursor-pointer bg-gradient-to-r from-gray-100 to-gray-200 text-gray-700 font-medium rounded-xl hover:from-gray-200 hover:to-gray-300 transition-all border border-gray-300/50 shadow-lg hover:shadow-xl",

  // Quiz in progress container
  quizContainer: "max-w-3xl mx-auto pb-8",
  quizHeaderCard:
    "mb-6 bg-white/90 backdrop-blur-xl p-5 md:p-6 rounded-3xl shadow-xl border border-white/30",
  quizHeader: "flex flex-col sm:flex-col items-center justify-between mb-6",
  quizTitle:
    "text-xl md:text-lg xl:text-2xl lg:text-xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent mb-2 sm:mb-0",
  reviewModeBadge:
    "text-xs xl:text-lg lg:text-md bg-gradient-to-r from-purple-100 to-violet-100 text-purple-800 px-3 py-1 rounded-full",
  statsGrid:
    "grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-2 lg:grid-cols-3 xl:grid-cols-3 mt-4 items-center space-x-4",

  // Timer display
  timerDisplay:
    "flex items-center space-x-2 px-4 py-2 rounded-full font-medium shadow-sm",
  timerText: "text-sm font-mono",

  // Progress badges
  questionBadge:
    "text-sm bg-gradient-to-r from-blue-100 to-indigo-100 text-blue-800 px-3 py-2 rounded-full font-medium shadow-sm",
  answeredBadgeQuiz:
    "text-sm bg-gradient-to-r from-emerald-100 to-teal-100 text-emerald-800 px-3 py-2 rounded-full font-medium shadow-sm",

  // Progress bar
  mainProgressBarContainer:
    "w-full bg-gradient-to-r from-gray-200 to-gray-300 rounded-full h-2.5 mb-2",
  mainProgressBar:
    "bg-gradient-to-r from-blue-400 to-purple-400 h-2.5 rounded-full transition-all duration-500",

  // Question indicators
  questionIndicators: "flex flex-wrap gap-2 mt-4",
  questionIndicator:
    "w-10 h-10 rounded-xl text-sm font-medium flex items-center justify-center transition-all hover:scale-110 hover:shadow-md shadow-sm",
  currentQuestion: "ring-2 ring-blue-400 ring-offset-2",

  // Time warning
  timeWarning:
    "mt-3 text-sm text-rose-600 flex items-center bg-gradient-to-r from-rose-50/80 to-pink-50/80 p-3 rounded-xl border border-rose-200/50",
  warningIcon: "mr-2",

  // Question card
  questionCard:
    "bg-white/90 backdrop-blur-xl p-6 md:p-8 rounded-3xl shadow-2xl border border-white/30 mb-6",
  questionHeader: "mb-6 flex justify-between items-center",
  questionIconContainer: "flex items-center",
  questionIcon:
    "bg-gradient-to-br from-blue-100 to-indigo-100 text-blue-600 p-3 rounded-2xl mr-3 shadow-sm",
  questionTextContainer: "text-lg md:text-xl font-semibold text-slate-800",

  // Status badge
  statusBadge:
    "px-2 py-2 mb-60 mr-60 md:mb-0 md:mr-0 lg:mb-0 lg:mr-0 xl:mb-0 xl:mr-0 items-center justify-between rounded-full text-sm font-medium",

  // Options container
  optionsContainer: "space-y-4 mt-6",
  optionButton:
    "w-full text-left p-5 mb-5 md:p-6 rounded-2xl border-2 transition-all duration-300 backdrop-blur-sm",
  ...
  correctAnswerBadge:
    "ml-auto text-xs bg-gradient-to-r from-emerald-100 to-teal-100 text-emerald-700 px-3 py-1.5 rounded-full font-medium",

  // Explanation section
  explanationContainer:
    "mt-8 p-5 bg-gradient-to-r from-blue-50/80 to-indigo-50/80 rounded-2xl border border-blue-200/50 backdrop-blur-sm",
  ...
  // Navigation buttons
  navButtonsContainer:
    "flex flex-col sm:flex-row md:flex-col lg:flex-row justify-between items-center gap-4",
  prevButton:
    "flex items-center space-x-2 px-5 py-3 rounded-xl font-medium transition-all shadow-sm",
  prevButtonEnabled:
    "bg-gradient-to-r from-blue-50 to-indigo-50 text-blue-600 hover:bg-gradient-to-r hover:from-blue-100 hover:to-indigo-100 hover:shadow-md",
  prevButtonDisabled:
    "bg-gradient-to-r from-gray-100 to-gray-200 text-gray-400 cursor-not-allowed",
  navRightContainer: "flex items-center space-x-3",
  nextButton:
    "px-6 py-3 cursor-pointer bg-gradient-to-r from-gray-100 to-gray-200 text-gray-700 font-medium rounded-xl hover:bg-gradient-to-r hover:from-gray-200 hover:to-gray-300 transition-all shadow-md hover:shadow-lg flex items-center space-x-2",
  submitButton:
    "px-8 cursor-pointer py-3 font-medium rounded-xl transition-all shadow-lg hover:shadow-xl",
  submitButtonResults:
    "bg-gradient-to-r from-purple-500 to-indigo-500 text-white hover:from-purple-600 hover:to-indigo-600",
  submitButtonQuiz:
    "bg-gradient-to-r from-rose-500 to-orange-500 text-white hover:from-rose-600 hover:to-orange-600",
  backToResultsButton:
    "px-8 cursor-pointer py-3 bg-gradient-to-r from-purple-500 to-indigo-500 text-white font-medium rounded-xl hover:from-purple-600 hover:to-indigo-600 transition-all shadow-lg hover:shadow-xl",

  // Loading state
  loadingState: "h-full flex items-center justify-center py-20",
  loadingCard:
    "text-center bg-white/90 backdrop-blur-xl p-8 md:p-12 rounded-3xl shadow-2xl border border-white/30",
  loadingSpinner:
...
export const getOptionButtonStyle = (
  ...
  if (!showFeedback) {
    if (isSelected) {
      return {
        ...
        radioClass:
          "bg-gradient-to-br from-blue-400 to-indigo-400 border-blue-500",
      };
    }
    return {
      buttonClass:
        "border-white/50 hover:border-blue-200 hover:bg-blue-50/50 hover:shadow-md",
  ...
  if (isCorrect) {
    return {
      buttonClass:
        "bg-gradient-to-r from-emerald-50 to-teal-50 border-emerald-300 text-emerald-700 shadow-md",
      textClass: "text-emerald-700",
      radioClass:
        "bg-gradient-to-br from-emerald-400 to-teal-400 border-emerald-500",
    };
  }
  ...
  if (isSelected) {
    return {
      buttonClass:
        "bg-gradient-to-r from-rose-50 to-pink-50 border-rose-300 text-rose-700 shadow-md",
